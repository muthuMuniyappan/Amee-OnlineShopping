 <div class="container footer">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; Online Shopping 2018 - This is my first Shopping Web site- Designed and Developed by muthuAmee </p>
...
<div class="footer-icons">
      ...
      <a href="https://instagram.com/" class="generic-anchor" target="_blank"><i class="fa fa-instagram"></i></a>
...
<i class="fa fa-copyright" role="copyright"></i> <strong> AmeeOnline Shopping 2018 - This is my first Shopping Web Site - Designed and Developed by muthuAmee </strong> <br>
